module github.com/whosonfirst/go-overture
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-iterate/v2 v2.3.2 // indirect
	...
	github.com/whosonfirst/go-whosonfirst-spr/v2 v2.3.6 // indirect
